                    ...
                    <div className="flex gap-4">
                      {canCancel && (
                        <button 
                          ...
                          className="inline-block border border-rose-600 text-rose-600 px-8 py-4 font-label text-[9px] tracking-[0.25em] uppercase hover:bg-rose-50 transition-all duration-500 text-center shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        >
